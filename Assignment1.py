...
#if youre calling function from itself, then call main. organizational purpose so if you call function from
# elsewhere, it won't be called. just keep this at the bottom
